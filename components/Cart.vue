        ...
        <div class=" ">
          ...
          >
            ...
            <TabGroup as="div" class="flex flex-row">
              <!-- Image selector -->
              <div
                class="mx-auto overflow-y-auto hidden h-[450px] max-w-xs w-32 sm:block lg:max-w-none"
              >
                <TabList class="grid gap-6 px-1 overflow-y-auto py-2">
                  <Tab
                    v-for="image in product.images"
                    :key="image.id"
                    class="relative flex h-24 cursor-pointer items-center justify-center bg-white text-sm font-medium uppercase text-gray-900 hover:bg-gray-50 focus:outline-none focus:ring focus:ring-opacity-50 focus:ring-transparent focus:ring-offset-4"
                    v-slot="{ selected }"
                  >
      ...
      <div class="">
        ...
        <div>
          <div class="flex items-center justify-between">
            <h2 class="block text-[12px] font-medium leading-6 text-grayPro">
              UK SIZES
            </h2>
          </div>
        ...
        <div class="my-8 flex items-center gap-4">
          <button
            class="px-10 py-2 bg-black rounded-lg border-2 border-black text-white font-bold"
          >
            Buy Now
          </button>

          <button
            class="px-6 py-2 flex items-center border-2 transition-all group hover:text-white hover:bg-black hover:border-black border-borderSecondary gap-2 bg-white rounded-lg text-black font-bold"
          >
            <svg
              width="24"
              height="24"
        ...
        <div class="flex justify-end gap-4 absolute bottom-0 right-0">
