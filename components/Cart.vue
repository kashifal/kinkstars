      ...
      <div class="">
        ...
        <div>
          <div class="flex items-center justify-between">
            <h2 class="block text-[12px] font-medium leading-6 text-[#3D3D3D]">
              UK SIZES
            </h2>
          </div>
        ...
        <div class="my-8 flex items-center gap-4">
          ...
          <button
            class="px-6 py-2 flex items-center border-2 transition-all group hover:text-white hover:bg-black hover:border-black border-[#E4E7EC] gap-2 bg-white rounded-lg text-black font-bold"
          >
            <svg
              width="24"
              height="24"
