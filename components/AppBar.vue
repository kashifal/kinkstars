      ...
      <div v-if="show" class="absolute left-0 w-full h-16 bg-gray-800 p-5 z-50">
        <div class="flex w-full items-center gap-x-6">
          <div class="relative text-gray-400 focus-within:text-gray-600 w-full">
            ...
            <input
              id="search"
              class="block w-full border-0 outline-none rounded-full py-1.5 pl-10 pr-3 text-gray-100 bg-gray-100"
              placeholder="Search"
              type="search"
              name="search"
            />
            ...
            >
              ...
              <div class="hidden w-full max-w-xl xl:block lg:max-w-xs">
                ...
                <div class="relative text-gray-400 focus-within:text-gray-600">
                  ...
                  <input
                    id="search"
                    class="block w-56 border-0 outline-none rounded-full py-2 pl-10 pr-3 text-gray-100 bg-gray-100"
                    placeholder="Search"
                    type="search"
                    name="search"
                  />
      ...
      <DisclosurePanel class="sm:hidden">
        ...
        <div class="pt-4 pb-3 border-t border-gray-200">
          <div class="flex items-center px-4">
            ...
            <button
              type="button"
              class="relative flex-shrink-0 p-1 ml-auto text-gray-400 bg-white rounded-full hover:text-gray-500 focus:outline-none focus:ring-2 focus:ring-primary focus:ring-offset-2"
            >
              <span class="absolute -inset-1.5" />
              <span class="sr-only">View notifications</span>
